...
export default function Hero() {
    return (
        <div className="bg-main mt-[80px] w-full flex justify-center items-center min-h-full bg-contain bg-no-repeat bg-right-80 bg-56% bg-hero-pattern">
            <div className="w-1200 grid grid-cols-2 p-10 md:py-20 2xl:py-40 gap-10">
                <div className=" flex flex-col justify-center p-10 items-start ">
                    ...
                    <button className=" px-12 py-4 bg-yellow-300 font-bold text-lg text-extrabold rounded border-2 border-solid border-black hover:bg-green-600">Get started</button>
                </div>
            </div>
            <div className=""></div>
        </div>
